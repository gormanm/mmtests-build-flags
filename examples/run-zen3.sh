...
VERSION="zen3-v1r1"
MMTESTS_GIT_COMMIT="0f5f291e08f088d40a2e9a4cd60c9b611ba6254f"
MONITORS="no-monitor"
...
CONFIG_LIST="
config-workload-stream-single-zen3
config-workload-stream-omp-llcs-spread-zen3
config-hpc-nas-d-class-mpi-256cpus-xfs-zen3-default
config-hpc-nas-d-class-mpi-256cpus-xfs-zen3-tuned
config-hpc-nas-d-class-mpi-Ncpus-xfs-zen3-selective
"
